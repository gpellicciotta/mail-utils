# Gmail Full-Archive Migration: Failed Messages Ledger

Companion data file to
[`gmail-full-archive-migration-report.md`](gmail-full-archive-migration-report.md) - every one of the
446 messages that initially failed Gmail's `messages.import` validation during the T0033 full-archive
migration, with its original date, subject, and how it was recovered. All 446 succeeded on the
attachment-stripped retry (2026-09-09); none remain unstored. See the report's
[Attachment-stripped retry](gmail-full-archive-migration-report.md#attachment-stripped-retry) and
[Error catalogue](gmail-full-archive-migration-report.md#error-catalogue) sections for how and why.
