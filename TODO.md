...
- [~] T0030 [owner: @antigravity] Plan a full store-in-gmail test run against the disposable tester.pellicciotta@gmail.com account, covering kill/resume of a long-running import and a curated subset covering every message T0020 found problematic.
